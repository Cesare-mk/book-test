...
public class SearchHttpAK {
    ...
    public static String AK = "ZNzbMLAIVEt4zeSDaebK6dPioHBTMDOZ";
    ...
    public String requestGetAKWithReturn(String strUrl, Map<String, String> param) throws Exception {
        if (strUrl == null || strUrl.length() <= 0 || param == null || param.size() <= 0) {
            return "";
        }
        ...
        reader.close();
        isr.close();
        return buffer.toString(); // 返回响应字符串，供测试断言
    }
}
